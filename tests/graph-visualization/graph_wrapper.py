...
class GraphManager:
    ...
    async def _send_command(
        ...
        self._confirmation_id = self._action_id  # Expecting this ID in the confirmation
        self._action_id += 1

        print(f"Sent command: {action} with actionId: {self._confirmation_id}. Waiting for confirmation...")
    ...
    async def confirmation_handler(self, message: dict) -> None:
        """Handle incoming messages, check if they confirm the sent actionId."""
        if message.get("actionId") == self._confirmation_id:
            print(f"Received confirmation for actionId: {self._confirmation_id}")
    ...
    async def set_graph_data(self, graph_data: GraphData) -> None:
        ...
        """
        return await self._send_command("graphData", None, dataclasses.asdict(graph_data))

    async def get_graph_data(self) -> GraphData:
        """
        Getter for graph data structure (see below for syntax details).
        """
        graph_dict = await self._send_command("graphData")
    ...
    async def json_url(self, url: str) -> None:
        ...
        """
        return await self._send_command("jsonUrl", [url])
    ...
    async def node_val(self, value: str | int | float = "val") -> None:
        ...
        volume).
        """
        return await self._send_command("nodeVal", [value])
    ...
    async def node_label(self, label: str = "name") -> None:
        ...
        """
        return await self._send_command("nodeLabel", [label])
    ...
    async def node_visibility(self, visibility: bool = "True") -> None:
        ...
        """
        return await self._send_command("nodeVisibility", [visibility])
    ...
    async def node_color(self, color: str = "color") -> None:
        ...
        """
        return await self._send_command("nodeColor", [color])
    ...
    async def set_node_resolution(self, resolution: int = 8) -> None:
        ...
        """
        return await self._send_command("nodeResolution", [resolution])
    ...
    async def get_node_resolution(self) -> int:
        ...
        circumference. Higher values yield smoother spheres.
        """
        return await self._send_command("nodeResolution")
    ...
    async def node_three_object(self, object3d: str) -> None:
        ...
        """
        return await self._send_command("nodeThreeObject", [object3d])
    ...
    async def node_three_object_extend(self, extend: bool = False) -> None:
        ...
        """
        return await self._send_command("nodeThreeObjectExtend", [extend])
    ...
    async def link_label(self, label: str = "name") -> None:
        ...
        prevent XSS vulnerabilities.
        """
        return await self._send_command("linkLabel", [label])
    ...
    async def link_visibility(self, visibility: bool = True) -> None:
        ...
        """
        return await self._send_command("linkVisibility", [visibility])

    async def link_color(self, color: str = "color") -> None:
        """
        Link object accessor function or attribute for line color. 
        """
        return await self._send_command("linkColor", [color])
    ...
    async def link_width(self, width: float = 0) -> None:
        ...
        """
        return await self._send_command("linkWidth", [width])
    ...
    async def set_link_resolution(self, resolution: int = 6) -> None:
        ...
        """
        return await self._send_command("linkResolution", [resolution])
    ...
    async def get_link_resolution(self) -> int:
        ...
        cylinder. Higher values yield smoother cylinders. Applicable only to links with positive width.
        """
        return await self._send_command("linkResolution")
    ...
    async def link_curvature(self, curvature: float = 0) -> None:
        ...
        """
        return await self._send_command("linkCurvature", [curvature])
    ...
    async def link_curve_rotation(self, rotation: float = 0) -> None:
        ...
        """
        return await self._send_command("linkCurveRotation", [rotation])
    ...
    async def link_material(self, material: str) -> None:
        ...
        """
        return await self._send_command("linkMaterial", [material])
    ...
    async def link_three_object(self, object3d: str) -> None:
        ...
        return await self._send_command("linkThreeObject", [object3d])
    ...
    async def link_three_object_extend(self, extend: bool = False) -> None:
        ...
        """
        return await self._send_command("linkThreeObjectExtend", [extend])
    ...
    async def link_directional_arrow_length(self, length: float = 0) -> None:
        ...
        """
        return await self._send_command("linkDirectionalArrowLength", [length])
    ...
    async def link_directional_arrow_color(self, color: str = "color") -> None:
        ...
        """
        return await self._send_command("linkDirectionalArrowColor", [color])
    ...
    async def link_directional_arrow_rel_pos(self, position: float = .5) -> None:
        ...
        """
        return await self._send_command("linkDirectionalArrowRelPos", [position])
    ...
    async def set_link_directional_arrow_resolution(self, resolution: int = 8) -> None:
        ...
        """
        return await self._send_command("linkDirectionalArrowResolution", [resolution])
    ...
    async def get_link_directional_arrow_resolution(self) -> int:
        ...
        cone base circumference. Higher values yield smoother arrows.
        """
        return await self._send_command("linkDirectionalArrowResolution")
    ...
    async def link_directional_particles(self, count: int = 0) -> None:
        ...
        """
        return await self._send_command("linkDirectionalParticles", [count])
    ...
    async def link_directional_particle_speed(self, speed: float = 0.01) -> None:
        ...
        """
        return await self._send_command("linkDirectionalParticleSpeed", [speed])
    ...
    async def link_directional_particle_width(self, width: float = 0.5) -> None:
        ...
        """
        return await self._send_command("linkDirectionalParticleWidth", [width])
    ...
    async def link_directional_particle_color(self, color: str = "color") -> None:
        ...
        """
        return await self._send_command("linkDirectionalParticleColor", [color])
    ...
    async def set_link_directional_particle_resolution(self, resolution: int = 4) -> None:
        ...
        """
        return await self._send_command("linkDirectionalParticleResolution", [resolution])
    ...
    async def get_link_directional_particle_resolution(self) -> int:
        ...
        divide the circumference. Higher values yield smoother particles.
        """
        return await self._send_command("linkDirectionalParticleResolution")
    ...
    async def emit_particle(self, edge) -> None:
        ...
        """
        return await self._send_command("emitParticle", [edge])
    ...
    async def pause_animation(self) -> None:
        ...
        """
        return await self._send_command("pauseAnimation")
    ...
    async def resume_animation(self) -> None:
        ...
        """
        return await self._send_command("resumeAnimation")
    ...
    async def set_camera_position(
        ...
        return await self._send_command("cameraPosition", arguments)

    async def get_camera_position(self) -> Position:
        """
        Getter for the camera position, in terms of `x`, `y`, `z` coordinates.
        """
        camera_position = await self._send_command("cameraPosition")
    ...
    async def zoom_to_fit(self, duration_ms: int = 0, padding_px: int = 10) -> None:
        ...
        """
        return await self._send_command("zoomToFit", [duration_ms, padding_px])
    ...
    async def refresh(self) -> None:
        ...
        """
        return await self._send_command("refresh")
    ...
    async def set_force_engine(self, engine: str = "d3") -> None:
        ...
        """
        return await self._send_command("forceEngine", [engine])
    ...
    async def get_force_engine(self) -> str:
        ...
        [*ngraph*](https://github.com/anvaka/ngraph.forcelayout)).
        """
        return await self._send_command("forceEngine")
    ...
    async def dag_mode(
        ...
        self._dag_mode = mode
        return await self._send_command("dagMode", [mode])
    ...
    async def deg_level_distance(self, distance: int) -> None:
        ...
        """
        return await self._send_command("dagLevelDistance", [distance])
    ...
    async def set_d3_alpha_min(self, alpha_min: float = 0.) -> None:
        ...
        """
        return await self._send_command("d3AlphaMin", [alpha_min])
    ...
    async def get_d3_alpha_min(self) -> float:
        ...
        parameter, only applicable if using the d3 simulation engine. 
        """
        return await self._send_command("d3AlphaMin")
    ...
    async def set_d3_alpha_decay(self, alpha_decay: float = .0228) -> None:
        ...
        parameter, only applicable if using the d3 simulation engine.
        """
        return await self._send_command("d3AlphaDecay", [alpha_decay])
    ...
    async def get_d3_alpha_decay(self) -> float:
        ...
        parameter, only applicable if using the d3 simulation engine.
        """
        return await self._send_command("d3AlphaDecay")
    ...
    async def set_d3_velocity_decay(self, velocity_decay: float = .4) -> None:
        ...
        """
        return await self._send_command("d3VelocityDecay", [velocity_decay])
    ...
    async def get_d3_velocity_decay(self) -> float:
        ...
        that simulates the medium resistance, only applicable if using the d3 simulation engine.
        """
        return await self._send_command("d3VelocityDecay")
    ...
    async def d3_reheat_simulation(self) -> None:
        ...
        simulation engine.
        """
        return await self._send_command("d3ReheatSimulation")
    ...
    async def set_warmup_ticks(self, ticks: int = 0) -> None:
        ...
        """
        return await self._send_command("warmupTicks", [ticks])
    ...
    async def get_warmup_ticks(self) -> int:
        ...
        """
        return await self._send_command("warmupTicks")
    ...
    async def set_cooldown_ticks(self, ticks: int = 0) -> None:
        ...
        """
        return await self._send_command("cooldownTicks", [ticks])
    ...
    async def get_cooldown_ticks(self) -> int:
        ...
        """
        return await self._send_command("cooldownTicks")
    ...
    async def link_hover_precision(self, precision: int = 1) -> None:
        ...
        """
        return await self._send_command("linkHoverPrecision", [precision])
    ...
    async def set_enable_pointer_interaction(self, enable: bool = True) -> None:
        ...
        property.
        """
        return await self._send_command("enablePointerInteraction", [enable])

    async def get_enable_pointer_interaction(self) -> bool:
        """
        Getter for whether to enable the mouse tracking events.
        """
        return await self._send_command("enablePointerInteraction")
    ...
    async def set_enable_node_drag(self, enable: bool = True) -> None:
        ...
        """
        return await self._send_command("enableNodeDrag", [enable])
    ...
    async def get_enable_node_drag(self) -> bool:
        ...
        """
        return await self._send_command("enableNodeDrag")
    ...
    async def set_enable_navigation_controls(self, enable: bool = True) -> None:
        ...
        """
        return await self._send_command("enableNavigationControls", [enable])
    ...
    async def get_enable_navigation_controls(self) -> bool:
        ...
        interactions (rotate/zoom/pan).
        """
        return await self._send_command("enableNavigationControls")
    ...
    async def graph_to_screen_coords(self, x: float, y: float, z: float) -> dict[Literal["x", "y"], float]:
        ...
        """
        return await self._send_command("graphToScreenCoords", [x, y, z])
    ...
    async def screen_to_graph_coords(self, x: float, y: float, distance: float) -> dict[Literal["x", "y", "z"], float]:
        ...
        """
        return await self._send_command("screenToGraphCoords", [x, y, distance])
